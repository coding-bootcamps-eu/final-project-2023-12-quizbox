  ...
  <main>
    <div class="flex-container--main">
      ...
      <label for="select-option" class="text--montserrat text--semibold text--small"
        >Choose a category with questions</label
      >
      <div class="select-wrapper">
        <select id="select-option" v-model="selectedCategory">
          <option value="basic-js">basic-js</option>
          <option value="web-app-foundation">web-app-foundation</option>
    ...
    <ul>
      <li v-for="question of questions[selectedCategory]" :key="question">
        {{ question }}
      </li>
    </ul>
  </main>
