<template>
  ...
  <BaseHeader :headline="textForMainContent.headline"
    ...
    ></BaseHeader
  >
  <BaseList :list-items="questionsFromSelectedCategory" class="list-item list-item--question"
...
export default {
  ...
  computed: {
    ...
    questionsFromSelectedCategory() {
      return this.quizData.find((categoryItem) => categoryItem.category === this.selectedCategory)
        ?.questions
    },
    numberOfQuestionsFromSelectedCategory() {
